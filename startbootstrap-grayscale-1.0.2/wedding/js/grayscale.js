...
setInterval(function () {
    ...
    countdown.innerHTML = '<div class=" text-center container-fluid" /*timer*/>'+

                '<div class="row">'+
                    '<div class="col-xs-3 ">'+
                        '<i class="fa">' + days + '</i><h4>Days</h5></a>' +
    '               </div>'+
                    ...
                    '<div class="col-xs-2">'+
                        '<i class="fa">' + hours + '</i><h4 >Hours</h5></a>'+
                    '</div>'+
                    ...
                    '<div class="col-xs-2">'+
                        '<i class="fa">' + seconds + '</i><h4>Seconds</h5></a>' +
                    '</div>'+
                '</div></div>';
